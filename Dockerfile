...
LABEL maintainer="stormalf.summonerswar@gmail.com"

RUN apt-get update && apt-get install -y git curl nano coreutils apt-utils less  && rm -rf /var/lib/apt/lists/*
...
# init.groovy doesn't exist by default and it contains groovy code after jenkins
# initialization
COPY init.groovy /usr/share/jenkins/ref/init.groovy.d/tcp-slave-agent-port.groovy
COPY init.groovy /usr/share/jenkins/ref/init.groovy.d/init.groovy
# à priori il faut ajouter .override pour que la nouvelle version soit prise en compte
